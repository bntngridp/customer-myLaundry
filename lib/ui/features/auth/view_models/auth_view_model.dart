...
class AuthViewModel extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'Halo,': 'Hello,',
      'Pakaian kamu sudah tumpuk nih, pesan yuk!': "Your laundry is piling up, let's order!",
      'Informasi Pesanan': 'Order Information',
      'Status Pesanan': 'Order Status',
      '4 Pilihan': '4 Options',
      'Jemput-Antar': 'Pick-up & Delivery',
      'Kurir antar jemput': 'Courier pick-up & delivery',
      'Cuci Lipat': 'Wash & Fold',
      'Bersih & terlipat': 'Clean & folded',
      'Cuci Satuan': 'Per-Item Wash',
      'Jas, gaun, kemeja': 'Suit, dress, shirt',
      'Cuci Setrika': 'Wash & Iron',
      'Licin, wangi & rapi': 'Sleek, fragrant & neat',
      'Semua': 'All',
      'Promo': 'Promo',
      'Notifikasi': 'Notifications',
      'Tandai dibaca': 'Mark as read',
      'Belum ada notifikasi': 'No notifications yet',
      'Pemberitahuan terkini akan muncul di sini': 'Recent updates will appear here',
      'Baru saja': 'Just now',
      'Konfirmasi Keluar': 'Logout Confirmation',
      'Apakah kamu yakin ingin keluar dari akun myLaundry?\nKamu perlu masuk kembali nanti untuk memesan.': 'Are you sure you want to log out of myLaundry?\nYou will need to log back in to place an order.',
      'Batal': 'Cancel',
